...
\ksremark{Po co? Jakie algorytmy? regex, na podstawie których tworzonych jest automat skończony (niedeterministyczny lub deterministyczny) Jaki narzędzia?  flex, jflex ...  }
subsection{Analiza składniowa}
\ksremark{Po co? Jakie algorytmy? analizatory wstępujące LALR(1), SLR, kanoniczny LR(1); analizator zstępujący LL(1)  Jaki narzędzia? bison, ... }
subsection{Analiza semantyczna}
translacja sterowana składnią   redukcja wywołuje akcję semantyczną
