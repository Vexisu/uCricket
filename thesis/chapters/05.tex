...
\ksremark{Poniższy listing trzeba wstawić w figure.}
\begin{lstlisting}
binary:
...
\begin{class}{StatementChain}{-6, -9}
\implement{Statement}
\attribute{item : Statement}
\attribute{next : StatementChain}
\end{class}

\begin{class}{ExpressionStatement}{-3, -13}
\implement{Statement}
\attribute{expression : Expression}
\end{class}

\begin{class}{FunctionCallExpression}{3, -13}
\implement{Expression}
\attribute{functionName : String}
\attribute{arguments : ArgumentsExpression}
\end{class}

\begin{class}{BinaryExpression}{6, -9}
\implement{Expression}
