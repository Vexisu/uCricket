...
Nazywanie elementów definiowanych przez użytkownika wymaga ścisłego używania nazw zgodnych z konwencją zapisu identyfikatorów. Identyfikatory przyjmują znaki alfanumeryczne, włącznie z dużymi i małymi literami, nie mogą zaczynać się cyfrą. \ksremark{Czy da się to opisać wyrażeniem regularnym?} Dana konwencja nazewnicza opisywana jest przez wyrażenie regularne:
\begin{lstlisting}
[a-zA-Z][a-zA-Z0-9]*
\end{lstlisting}
