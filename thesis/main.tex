...
%\bibliographystyle{plplain}  % bibtex
%\bibliography{biblio/biblio} % bibtex
\printbibliography[heading=subsubbibnumbered, type=book,title={Książki}]
\printbibliography[heading=subsubbibnumbered, type=article,title={Artykuły}]
\printbibliography[heading=subsubbibnumbered, type=inproceedings,title={Materiały konferencyjne}]
\printbibliography[heading=subsubbibnumbered, type=techreport,title={Dokumentacja techniczna}]
\printbibliography[heading=subsubbibnumbered, type=online,title={Strony internetowe}]
